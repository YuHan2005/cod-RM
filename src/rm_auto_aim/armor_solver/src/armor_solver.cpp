...
Solver::Solver(std::weak_ptr<rclcpp::Node> n) : node_(n) {
 ...
 // 声明并获取参数
 shooting_range_w_ = node->declare_parameter("solver.shooting_range_width", 0.135);//射击范围的宽度
  shooting_range_h_ = node->declare_parameter("solver.shooting_range_height", 0.135);//射击范围的高度
